...
const Blog = () => {
  return (
    <div className='w-full h-auto px-6 sm:px-8 md:px-12 lg:px-20 xl:px-28 pb-8'>
        <div className='xl:w-7/12 lg:w-7/12 md:w-8/12 sm:w-full w-full mx-auto xl:float-left lg:float-left' id='color'>
            ...
            <p className='text-justify leading-loose font-mono text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl pt-6 text-rose-600'>
